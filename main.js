    ...
    function addGUI () {
        ...
        map.on("click", function(e) {
            ...
            if (e.originalEvent.ctrlKey || e.originalEvent.commandKey) {
                var url = 'https://tile.dev.mapzen.com/mapzen/vector/v1/all/' + scene.tile_manager.view.zoom + '/' + long2tile(e.latlng.lng,scene.tile_manager.view.zoom)  + '/' + lat2tile(e.latlng.lat,scene.tile_manager.view.zoom) + '.topojson?api_key=vector-tiles-HqUVidw';
                window.open(url, '_blank');
            }
        });
    }
